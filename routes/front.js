...
router.post("/contact", async (req, res) => {
  let email = req.body.user_email; //this is the client email id
  let subject = "Mail from contact form.";
  const { full_name, user_email, message } = req.body;
  let text = `<p>Name - ${req.body.full_name}</p>
      <p>Email - ${req.body.user_email}</p>
...
// router.post("/metamask", isUser, userControllers.initialize);
