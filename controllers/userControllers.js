...
const submitUser = async (req, res) => {
  ...
  if (user) {
    ...
    if (req.body.password == req.body.conf_pass) {
      ...
      let otp = user.otp;
      let subject =
        "OTP for your new account on The Finance Blocks website";
      let text =
        "Hello " +
        req.body.email +
        ",<br><br>\n\nCongratulations on signing up with The Finance Blocks website!<br><br>\n\n" +
...
//                     req.session.re_usr_email = user.email;
//                     req.session.is_user_logged_in = false;
//                     let subject = 'OTP for your new account on Finance Blocks website';
//                     let text = 'Hello ' + req.body.email + ',<br><br>\n\nCongratulations on signing up with Finance Blocks website!<br><br>\n\n' +
//                         'Your one-time password (OTP) for signing up is: ' + otp + '. This would be valid only for the next 10 minutes.' +
//                         '<br><br>\n\nOnce you enter the OTP and create a new wallet, we will credit it by 50 Finance Blocks (worth US$50)  as a limited-time joining bonus.<br><br>\n\n' +
//                         'Moreover, you can earn more by referring your friends and earn US$10 equivalent Finance Blocks tokens every time your friend joins by using your referral code. Your friend will also get US$10 equivalent Finance Blocks tokens for using your referral code !<br><br>\n\n' +
//                         'Time: ' + user.created + '<br><br>\n\n'
//                     'If this withdrawal attempt was not made by you it means someone visited your account. It may be an indication you have been the target of a phishing attempt and might want to consider moving your funds to a new wallet.' + '<br><br>\n\n' + 'Regards,<br>\nFinance Blocks Team<br>\nhttps://ebtico.com';
//                     await mail(req.body.email, subject, text);
//                     req.flash('success_msg', 'User registered. Please verify to continue.');
//                     res.redirect('/verify-account');
//                 }
